...
activities = {
    ...
    "Swimming Club": {
        "description": "Improve swimming technique and train for swim meets",
        "schedule": "Tuesdays and Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["lucas@mergington.edu", "zoey@mergington.edu"]
    },
    "Drama Club": {
        "description": "Explore acting, script reading, and stage performance",
    ...
    "Art Workshop": {
        ...
        "max_participants": 16,
        "participants": ["avery@mergington.edu", "lily@mergington.edu"]
    },
    "Debate Society": {
        "description": "Practice public speaking, research, and argumentation skills",
